...
// CONFIG
$font = dirname(__FILE__)."/include/VeraSeBd.ttf";
$signature = "";
$perturbation = 0.75; // bigger numbers give more distortion; 1 is standard
$imgwid = 150; // image width, pixels
$imghgt = 50; // image height, pixels
$numcirc = 2; // number of wobbly circles
$numlines = 1; // number of lines
// END CONFIG
