...
class Mailer 
{
 ...
 function _constructor($xml) 
 {
	...
	if(!empty($mailers)) 
	{
		...
		{
			//print_r($mailer);
			$this->Registry[ucfirst($mailer['attrs']['ID'])] = $mailer['attrs']['CLASS'];
			//echo $this->Registry[ucfirst($mailer['attrs']['ID'])];
		}
	}
 }
 function Mailer($xml)
 ...
 {
 	if($Mailer == 'Default' || $this->Registry[$Mailer])
	{
		...
		{
			require_once("parlance/classes/$Class.php");
