...
<form action="/contact/request/" onsubmit="Req(this,'/contact/request/request.php');return false;" method="post">
	...
	<p><?=FormLabel($AppContext, 'Description')?>&nbsp;&nbsp;<span id="RequestError" class="GrnTxt"></span><br/><textarea class="Input" name="request" rows="10" cols="15" wrap="soft" style="width:400px;" tabindex="3"></textarea></p>
