	<p class="SectionHeader">Top Songs</p>
...
?>
		<tr<?=(isset($SongInfo->SongID) && $_REQUEST['sid']==$SongInfo->SongID)?" class=\"Current\"":""?> id="<?=$SongInfo->ArtistID,$SongInfo->SongID?>">
			...
			<td valign="top"><h3><a href="/music/play/top10/<?=$SongInfo->ArtistID?>/<?=$SongInfo->SongID?>"><?=ucwords($SongInfo->ArtistName)?></a><br/><a href="/music/play/top10/<?=$SongInfo->ArtistID?>/<?=$SongInfo->SongID?>"><small class="BluTxt"><?=ucwords($SongInfo->Title)?></small></a></h3></td>
		</tr>
<?php
		}
	}
