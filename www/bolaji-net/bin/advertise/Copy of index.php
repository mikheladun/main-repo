  ...
  <div id="Container">
    <div id="MainContent">
      <div class="ContentDiv" style="margin-right:1em;">
		...
		<div class="PaddedBox">
				<big><big><strong>Welcome to the new Bolaji.net Advertising Specs site.</strong></big></big>
				<p>We've redesigned the site to make finding the specs for your campaign easier.</p>
			</div>
